  ...
  ((inst make-hasheq Symbol String)
   (append
    ...
    `((bo        . "Bind off")
      ...
      (ssbrk        . "Slip, slip, brioche knit slipped stitches together: Slip next stitch knitwise, with its corresponding yarn over. Slip next stitch knitwise. Insert left needle from behind into the 3 loops to hold them in place while you knit them together")
      ...
      (ssbrp        . "Slip, slip, brioche purl slipped stitches together: Slip next stitch knitwise, with its corresponding yarn over. Slip next stitch knitwise. Insert the right needle through their back loops, going into the second stitch, then the first, and purl them together")

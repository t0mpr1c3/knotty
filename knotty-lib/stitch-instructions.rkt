  ...
  ((inst make-hasheq Symbol String)
   (append
    ...
    `((bo        . "Bind off")
      ...
      (yf-sl-yoyo   . "Yarn forward, slip 1, yarn over twice: Bring yarn forward and under right needle. Slip next stitch purlwise, then bring yarn over right needle to the back, then under to the front, then over the needle again to the back")

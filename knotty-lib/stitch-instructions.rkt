  ...
  ((inst make-hasheq Symbol String)
   (append
    ...
    `((bo        . "Bind off")
      ...
      (kyk       . "Knit, yarn forward and knit again into next stitch")
      ...
      (pyp       . "Purl, yarn round needle and purl again into next stitch")
      ...
      (ssk       . "Slip, slip, knit: Slip 1 knitwise twice. Insert left needle from left to right through the front of both stitches and knit together through the back loops")
      (ssp       . "Slip, slip, purl: Slip 1 knitwise twice. Insert left needle from front through both stitches and slip back onto left needle. Purl together through back of loops by inserting right needle from left to right into backs of both stitches")
      (sl1-k2tog-psso   . "Slip next stitch knitwise, knit 2 together, pass slipped stitch over") ;; = sssk
      (sssk      . "Slip 1 knitwise 3 times. Insert left needle from back through all 3 stitches and knit 3 together") ;; = sl1-k2tog-psso
      (sssp      . "Slip, slip, slip, purl: Slip 1 knitwise 3 times. Insert left needle from front through all 3 stitches and slip back onto left needle. Purl together through back of loops by inserting right needle from left to right into backs of all 3 stitches")
      ...
      ;; brioche
      (yfsyo     . "Brioche slip: Bring yarn forward and under right needle. Slip next stitch purlwise, then bring yarn over right needle to back of work. On the following row, work these two loops together")
      (brk       . "Brioche knit: Knit the next stitch together with its corresponding yarn over from the previous row")
      (brp       . "Brioche purl: Knit the next stitch together with its corresponding yarn over from the previous row")
      (brk3tog   . "Brioche knit 3 together: Knit next stitch and corresponding yarn over together with the following stitch, return the stitch just worked to left needle, pass the second stitch on left needle (with its corresponding yarn over) over first stitch. Return completed stitch from left to right needle")
      (brsssk    . "Brioche slip slip slip knit: Slip next stitch, and corresponding yarn over, knitwise. Slip next stitch knitwise, brioche knit 1, pass slipped stitches over")
      )
